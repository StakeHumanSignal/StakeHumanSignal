  ...
  return (
    <html lang="en" className={`dark ${spaceGrotesk.variable} ${inter.variable} ${jetbrainsMono.variable} antialiased`}>
      <body className="min-h-screen bg-background text-on-surface font-[family-name:var(--font-body)]">
        ...
        {/* Bottom Terminal Bar */}
        <footer className="fixed bottom-0 w-full z-50 flex items-center px-4 h-8 bg-[#000000] border-t border-[#00F0FF]/20 overflow-hidden font-[family-name:var(--font-mono)] text-[10px] uppercase tracking-widest">
